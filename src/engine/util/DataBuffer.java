...
/**
 * TBuffer is a template class for creating transfer buffers for a Cell. Instead
 * of creating separate transfer maps to transfer data from one cell to another
 * each cell will contain a buffer that will hold information about what needs
 * to be moved and then applied later after an update has been made on a map.
 *
...
public abstract class DataBuffer {
   ...
   */
  public void bufferIsSet(boolean b) {
    bufferSet = b;
  }
