...
public enum Layer {
    ...
    /**
     * Sand is formed when gravel breaks down, also from other rock types
    ...
    /**
     * Gravel is formed when Igneous or metamorphic rocks break down,
     * over time gravel will break down into Sand.
     */
     ...
     * biological life deposits this rock.
     */
    LIMESTONE   ("Limestone", RockType.SEDIMENTARY, new Color(226,245,170), 5, 0.18f, 2550f),
    
    /**
     * Metamorphic rock forms at fault boundaries when rock
     * subducts and get twisted and compressed or if enough sedimentary rock 
     * is at a particular depth to form metamorphic rock.
     * Metamorphic rock also takes the longest to erode.
     */
    ...
    /**
     * Sea water is represented as a top layer. The average density of
     * sea water is around 1.05 cc. Sea water deposits shale rock.
     */
    OCEAN       ("Liquid Water", RockType.NULL, Color.BLUE, 9, 0.0f, 1050f),
    
    /**
     * Lava, not magma, is represented by this layer. It's average density
     * is 2.75 cc. lava can erode or deposit. If the lava is hot enough it
     * will carve out rock. If the lava is cool enough it deposits basalt.
     */
    LAVA        ("Lava", RockType.NULL, Color.RED, 10, 0.0f, 2750f),
    
    /**
     * Ice is represented by this layer and has a density of 0.9 cc. 
     * Ice erodes rock and deposits gravel instead of sand. The gravel
     * is one layer below ice and is only formed when ice moves.
     */
    ICE         ("Ice", RockType.NULL, new Color(230, 248, 248), 11, 0.0f, 900f);
    
    /**
     * The name of the material this stratum is. This includes 
     * Sediment, Sedimentary, Igneous, and Metamorphic.
     */
    private String name;
    ...
    /**
     * The rock group that this layer belongs to. In some cases the rock type
     * is not used, water, lava, and ice do not fall into any rock groups.
     */
